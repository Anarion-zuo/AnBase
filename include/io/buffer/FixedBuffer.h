...
#ifndef MYCPPBASE_FIXEDBUFFER_H
#define MYCPPBASE_FIXEDBUFFER_H
...
//        };
    ...
    public:
        explicit FixedBuffer(size_type frameLength = 1024);
        ...
        void append_arr(FixedBuffer &buffer, size_type len);
        void write_arr(FixedBuffer &buffer, size_type len);
